...
- **ly4096x-packages-feeds**: Configures the package feed in OpenWrt (supports both OPKG and APK).
- **fish**: The Fish shell.
...
**Option A: Install Feed Package (Recommended)**

```sh
# For OPKG
wget https://ly4096x.github.io/my-openwrt-packages/24.10/packages/aarch64_cortex-a53/ly4096x-packages-feeds.ipk
opkg install ly4096x-packages-feeds.ipk

# For APK
wget https://ly4096x.github.io/my-openwrt-packages/25.12/packages/aarch64_cortex-a53/ly4096x-packages-feeds.apk
# or wget https://ly4096x.github.io/my-openwrt-packages/SNAPSHOT/packages/aarch64_cortex-a53/ly4096x-packages-feeds.apk for SNAPSHOT
apk add --allow-untrusted ly4096x-packages-feeds.apk
```
